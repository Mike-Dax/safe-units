...
export function measureToUnitString<Basis, U extends Unit<Basis>, AllowedPrefix extends PrefixMask>(
  ...
  // Sort dimensions to ensure consistent order
  dimensions.sort()

  const unitString = dimensions
    .map(dim => {
      const exponent = unit[dim]
      // We don't need to include dimensions with exponent 0
      if (exponent === 0) return ""
      // We don't need to include the exponent if it's 1
      if (exponent === 1) return dim
      return `${String(dim)}^${exponent}`
    })
    .filter(Boolean)
    .join("&")

  return unitString ?? "dimensionless" // Return 'dimensionless' for dimensionless units
}

// Object of unit strings to their nice TitleCase names.
export const unitStringToNiceNames = {
  [measureToUnitString(Dimensionless)]: "Dimensionless",
  [measureToUnitString(Length)]: "Length",
  ...
  [measureToUnitString(PlaneAngle)]: "Plane Angle",
  [measureToUnitString(SolidAngle)]: "Solid Angle",
  [measureToUnitString(Frequency)]: "Frequency",
  [measureToUnitString(FrequencyDrift)]: "Frequency Drift",
  [measureToUnitString(FuelEfficiency)]: "Fuel Efficiency",
  [measureToUnitString(Wavenumber)]: "Wavenumber",
  [measureToUnitString(Area)]: "Area",
  [measureToUnitString(Volume)]: "Volume",
  [measureToUnitString(Absement)]: "Absement",
  [measureToUnitString(Velocity)]: "Velocity",
  [measureToUnitString(Acceleration)]: "Acceleration",
  [measureToUnitString(Jerk)]: "Jerk",
  [measureToUnitString(Jounce)]: "Jounce",
  [measureToUnitString(Crackle)]: "Crackle",
  [measureToUnitString(Pop)]: "Pop",
  [measureToUnitString(VolumetricFlow)]: "Volumetric Flow",
  [measureToUnitString(MassFlowRate)]: "Mass Flow Rate",
  [measureToUnitString(LinearDensity)]: "Linear Density",
  [measureToUnitString(AreaDensity)]: "Area Density",
  [measureToUnitString(VolumeDensity)]: "Volume Density",
  [measureToUnitString(Force)]: "Force",
  [measureToUnitString(Yank)]: "Yank",
  [measureToUnitString(Pressure)]: "Pressure",
  [measureToUnitString(Compressibility)]: "Compressibility",
  [measureToUnitString(DynamicViscosity)]: "Dynamic Viscosity",
  [measureToUnitString(SurfaceTension)]: "Surface Tension",
  [measureToUnitString(Momentum)]: "Momentum",
  [measureToUnitString(MomentOfInertia)]: "Moment Of Inertia",
  [measureToUnitString(Energy)]: "Energy",
  [measureToUnitString(Power)]: "Power",
  [measureToUnitString(PowerDensity)]: "Power Density",
  [measureToUnitString(Voltage)]: "Voltage",
  [measureToUnitString(ElectricCharge)]: "Electric Charge",
  [measureToUnitString(ElectricChargeDensity)]: "Electric Charge Density",
  [measureToUnitString(ElectricCurrentDensity)]: "Electric Current Density",
  [measureToUnitString(ElectricDisplacement)]: "Electric Displacement",
  [measureToUnitString(EletricFieldStrength)]: "Electric Field Strength",
  [measureToUnitString(ElectricalCapacitance)]: "Electrical Capacitance",
  [measureToUnitString(ElectricalConductance)]: "Electrical Conductance",
  [measureToUnitString(ElectricalConductivity)]: "Electrical Conductivity",
  [measureToUnitString(ElectricalResistance)]: "Electrical Resistance",
  [measureToUnitString(ElectricalResistivity)]: "Electrical Resistivity",
  [measureToUnitString(ElectricalInductance)]: "Electrical Inductance",
  [measureToUnitString(LinearChargeDensity)]: "Linear Charge Density",
  [measureToUnitString(Permittivity)]: "Permittivity",
  [measureToUnitString(MagneticFlux)]: "Magnetic Flux",
  [measureToUnitString(MagneticFluxDensity)]: "Magnetic Flux Density",
  [measureToUnitString(MagneticPermeability)]: "Magnetic Permeability",
  [measureToUnitString(Magnetization)]: "Magnetization",
  [measureToUnitString(MagneticReluctance)]: "Magnetic Reluctance",
  [measureToUnitString(MagneticMoment)]: "Magnetic Moment",
  [measureToUnitString(MagneticRigidity)]: "Magnetic Rigidity",
  [measureToUnitString(MagneticDipoleMoment)]: "Magnetic Dipole Moment",
  [measureToUnitString(MagneticSusceptibility)]: "Magnetic Susceptibility",
  [measureToUnitString(Irradiance)]: "Irradiance",
  [measureToUnitString(Entropy)]: "Entropy",
  [measureToUnitString(SpecificHeat)]: "Specific Heat",
  [measureToUnitString(SpecificVolume)]: "Specific Volume",
  [measureToUnitString(ThermalConductivity)]: "Thermal Conductivity",
  [measureToUnitString(ThermalResistance)]: "Thermal Resistance",
  [measureToUnitString(ThermalExpansionCoefficient)]: "Thermal Expansion Coefficient",
  [measureToUnitString(ThermalGradient)]: "Thermal Gradient",
  [measureToUnitString(MolarEntropy)]: "Molar Entropy",
  [measureToUnitString(MolarEnergy)]: "Molar Energy",
  [measureToUnitString(Molarity)]: "Molarity",
  [measureToUnitString(MolarVolume)]: "Molar Volume",
  [measureToUnitString(Molality)]: "Molality",
  [measureToUnitString(MolarMass)]: "Molar Mass",
  [measureToUnitString(MolarConductivity)]: "Molar Conductivity",
  [measureToUnitString(CatalyticActivity)]: "Catalytic Activity",
  [measureToUnitString(CatalyticEfficiency)]: "Catalytic Efficiency",
  [measureToUnitString(ReactionRate)]: "Reaction Rate",
  [measureToUnitString(RadiationDose)]: "Radiation Dose",
  [measureToUnitString(RadiationDoseRate)]: "Radiation Dose Rate",
  [measureToUnitString(ElectronMobility)]: "Electron Mobility",
  [measureToUnitString(AngularMomentum)]: "Angular Momentum",
  [measureToUnitString(SpecificAngularMomentum)]: "Specific Angular Momentum",
  [measureToUnitString(Luminance)]: "Luminance",
  [measureToUnitString(LuminousFlux)]: "Luminous Flux",
  [measureToUnitString(Illuminance)]: "Illuminance",
  [measureToUnitString(LuminousEnergy)]: "Luminous Energy",
  [measureToUnitString(LuminousExposure)]: "Luminous Exposure",
  [measureToUnitString(LuminousEfficiency)]: "Luminous Efficiency",
  [measureToUnitString(RadiantIntensity)]: "Radiant Intensity",
  [measureToUnitString(SpectralIntensity)]: "Spectral Intensity",
  [measureToUnitString(Radiance)]: "Radiance",
  [measureToUnitString(SpectralRadiance)]: "Spectral Radiance",
  [measureToUnitString(AngularVelocity)]: "Angular Velocity",
  [measureToUnitString(AngularAcceleration)]: "Angular Acceleration",
}
