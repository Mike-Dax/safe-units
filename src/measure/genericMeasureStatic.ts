...
import { BinaryFn, PrefixFn, SpreadFn, wrapBinaryFn, wrapUnaryFn, wrapReducerFn } from "./genericMeasureUtils"
...
export interface GenericMeasureStatic<N> {
  ...
  pow<Basis, Left extends Unit<Basis>, Power extends number>(
    left: GenericMeasure<N, Basis, Left>,
    power: Power,
  ): GenericMeasure<N, Basis, UnitToPower<Basis, Left, Power>>
