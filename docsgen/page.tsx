    ...
    <Container>
      ...
      <Contents>
        <Body>
          ...
          <EndMatter>
            <Link href="https://github.com/jscheiny/safe-units">Safe Units</Link> is developed by Jonah Scheinerman.
            Please <Link href="mailto:jonah@scheinerman.net">contact me</Link> if you have questions or concerns.
            <License>
